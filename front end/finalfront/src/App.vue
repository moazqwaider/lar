          ...
          <div class="container flex">
              ...
              <div class="flex items-center justify-between flex-grow md:pl-12 py-5">
                  <div class="flex items-center space-x-6 capitalize">
                      ...
                      <router-link class="text-gray-200 hover:text-white transition" to="/" active-class="text-primary">Home</router-link>
                      <router-link to="/shop" class="text-gray-200 hover:text-white transition" active-class="text-primary">Shop</router-link>
                      <router-link to="/about-us" class="text-gray-200 hover:text-white transition" active-class="text-primary">About us</router-link>
                      <router-link to="/contact_us" class="text-gray-200 hover:text-white transition" active-class="text-primary">Contact us</router-link>
                  </div>
